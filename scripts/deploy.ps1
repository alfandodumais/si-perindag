...
$remoteCommand = "cd $VpsDir && tar -xzf sipikem-deploy.tar.gz && mkdir -p public/uploads && chmod -R 775 public/uploads && (pm2 restart sipikem || PORT=3000 pm2 start server.js --name sipikem)"
