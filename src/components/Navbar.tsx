...
export default function Navbar() {
  ...
  const navItems = [
    ...
    { label: 'Pendaftaran IKM', href: '/daftar', icon: FileText },
  ...
  return (
    <header className="sticky top-0 z-50 bg-[#08192c]/95 backdrop-blur-xl border-b border-sky-500/15 text-white shadow-lg shadow-sky-950/20 transition-all duration-200">
        ...
        <div className="flex items-center justify-between h-[72px]">
          ...
          <Link href="/" className="flex items-center gap-3 group shrink-0">
            ...
            <div className="flex flex-col">
              ...
              <p className="text-[10px] sm:text-[11px] text-sky-200/70 font-medium tracking-tight whitespace-nowrap leading-tight">
            ...
            {navItems.map((item) => {
              ...
              return (
                <Link
                  key={item.href}
                  href={item.href}
                  className={`group/nav relative flex items-center gap-1.5 xl:gap-2 px-3 xl:px-3.5 py-2 rounded-xl text-xs xl:text-[13px] font-medium whitespace-nowrap transition-all duration-200 ${
                    isActive
                ...
                >
                  <Icon
                    className={`w-4 h-4 shrink-0 transition-transform duration-200 group-hover/nav:scale-110 ${
          ...
          <div className="hidden lg:flex items-center gap-2 xl:gap-2.5 shrink-0">
            <Link
              href="/admin/login"
              className="whitespace-nowrap flex items-center gap-1.5 px-3 xl:px-3.5 py-2 text-xs font-semibold text-sky-200 hover:text-white bg-white/[0.04] hover:bg-white/[0.09] rounded-xl transition-all duration-200 border border-white/10 hover:border-sky-400/30 shadow-xs"
            >
      ...
      {/* Mobile Drawer */}
      {mobileMenuOpen && (
        <div className="lg:hidden bg-[#071626]/98 backdrop-blur-2xl border-b border-sky-500/20 px-4 pt-3 pb-6 space-y-1.5 shadow-2xl">
